(defproject bras-cubas "0.0.1-SNAPSHOT"
  ...
  :profiles {:dev {:aliases {"run-dev" ["trampoline" "run" "-m" "bras-cubas.server/run-dev"]}
                   :dependencies [[io.pedestal/pedestal.service-tools "0.5.7"]]}
             :uberjar {:aot [bras-cubas.server]}}
  :main ^{:skip-aot true} bras-cubas.server)
